    ...
    <table id="myTable" class="table table-striped" style="width:100%">
        ...
        <tbody class="text-center">
            ...
            <tr>
                ...
                <td>{{ $row->wharehouse->name }}</td>
                <td>
                    <a href="{{ url('admin/stock/'.$row->id.'/edit') }}" class="btn btn-success btn-sm"><i class="bi bi-pencil-fill"></i></a>
                    <a href="{{ url('admin/stock/'.$row->id.'/delete') }}" class="btn btn-danger btn-sm" onclick="return remove();"><i class="bi bi-trash-fill"></i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
