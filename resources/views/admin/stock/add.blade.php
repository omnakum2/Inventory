...
@section('page-title')
<span>Add Stock <a href="{{ url('admin/stock') }}" class="btn btn-dark btn-color float-end">Back</a></span>
@endsection
        ...
        <div class="card-body">
            <form action="{{ url('admin/stock/store') }}" method="post">
                ...
                <div class="row-md-6 mt-3">
                    ...
                    <input type="text" name="quantity" class="form-control @error('quantity') is-invalid @enderror" placeholder="Enter Stock">
