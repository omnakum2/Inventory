...
@section('page-title')
<span>Edit Profile <a href="{{ url('admin/dashboard') }}" class="btn btn-dark btn-color float-end">Back</a></span>
@endsection
...
<div class="container">
    ...
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form method="POST" action="{{ url('admin/profile/'.$user->id.'/update') }}">
                @csrf
